...
Public Class ReportPenerima
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Pengambilan_Perlengkapan.ReportPenerima.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportPenerima
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportPenerima = New ReportPenerima()
        rpt.Site = Me.Site
        Return rpt
    End Function
